...
- [Matrices Decompositions](5_Dense_Linear_Problems_And_Decompositions.md#matrices-decompositions)
  ...
  * [Basis of Null space and Kernel](5_Dense_Linear_Problems_And_Decompositions.md#basis-of-null-space-and-kernel)
    ...
    + [Null Space](5_Dense_Linear_Problems_And_Decompositions.md#null-space)
...
- [Solving Linear Equation](5_Dense_Linear_Problems_And_Decompositions.md#solving-linear-equation)
  * [Gaussian Elimination](5_Dense_Linear_Problems_And_Decompositions.md#gaussian-elimination)
    ...
    + [Example of The Gaussian Elimination Algorithm](5_Dense_Linear_Problems_And_Decompositions.md#example-of-the-gaussian-elimination-algorithm)
    ...
    + [Computing Ranks and Bases](5_Dense_Linear_Problems_And_Decompositions.md#computing-ranks-and-bases)
  * [Conclusion on Computing Rank](5_Dense_Linear_Problems_And_Decompositions.md#conclusion-on-computing-rank)
